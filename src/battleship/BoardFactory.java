            ...
            while (true) {
                ...
                if (getLetter1Int == getLetter2Int) {      //inserting ships horizontally
                    ...
                    try {
                        //insert
                        for (int i = minNum; i <= maxNum; i++) {
                            square.getField()[getLetter1Int][i] = ConsoleColors.GREEN_BOLD + "O" + ConsoleColors.RESET;
                    ...
                    try {
                        //insert
                        for (int i = minLetterInt; i <= maxLetterInt; i++) {
                            square.getField()[i][getNum1] = ConsoleColors.GREEN_BOLD + "O" + ConsoleColors.RESET;
